...
class AllInOneModel {
  ...
  factory AllInOneModel.fromJson(Map<String, dynamic> a) {
    ...
    return AllInOneModel(
      trivias: (data['trivias'] as List<dynamic>? ?? [])
          .map((e) => Triviamodel.fromJson(e as Map<String, dynamic>))
          .toList(),
      category: (data['cat_info'] as List<dynamic>? ?? [])
          .map((c) => CategoryModel.fromJson(c as Map<String, dynamic>))
          .toList(),
      disceaseList: (data['disease_info'] as List<dynamic>? ?? [])
          .map((d) => DisceaseList.fromJson(d as Map<String, dynamic>))
          .toList(),
    );
  }
}
...
class Triviamodel {
  ...
  factory Triviamodel.fromJson(Map<String, dynamic> e) {
    return Triviamodel(id: e['id'], trivia: e['trivia']);
  }

  Map<String, dynamic> toTriviaMap() {
    return {'id': id, 'trivia': trivia};
  }
...
class DisceaseList {
  ...
  Map<String, dynamic> DisceasetoMap() {
    return {'id': id, 'cat_id': cat_id, 'name': disceaseName};
  }
...
class CategoryModel {
  ...
  factory CategoryModel.fromJson(Map<String, dynamic> c) {
    return CategoryModel(id: c['id'], name: c['name'], image: c['image']);
  }
