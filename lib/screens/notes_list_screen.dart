  ...
  Widget build(BuildContext context) {
    return Scaffold(
                  ...
                  child: ListTile(
                    ...
                    onTap: () {
                      Navigator.push(
                        ...
                        MaterialPageRoute(
                          builder: (_) =>
                              EditNoteScreen(noteData: notes[index]),
                        ),
                      ).then((_) {
                        loadNotes();
                      });
      ...
      floatingActionButton: ElevatedButton(
        style: ButtonStyle(
          backgroundColor: WidgetStatePropertyAll(ColorUtils.selectedColor),
        ),
        onPressed: () {
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (_) =>
                  NotesScreen(diseaseId: widget.diseaseId, image: widget.image),
            ),
          ).then((_) {
            loadNotes();
          });
