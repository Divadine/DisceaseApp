...
class _EditNoteScreenState extends State<EditNoteScreen> {
  ...
  Future<void> updateNote() async {
    await DbHelper.instance.updateNotes(id : widget.noteData['id'] , title : titleController.text,content : contentController.text,);
  ...
  Widget build(BuildContext conetext){
    return Scaffold(
      appBar: AppBar(
        title: Text('Notes',style: TextStyle(fontWeight: FontWeight.bold,fontSize: 20,color: Colors.white),),
        centerTitle: true,
        actions: [
