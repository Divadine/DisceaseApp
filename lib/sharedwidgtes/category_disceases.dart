            ...
            isLoading
                ...
                : ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      bool isBookmarked =
                          bookmarkedDiseases[disease.id] ?? false;
                      return Card(
                            ...
                            onPressed: () async {
                              if (isBookmarked) {
                                ...
                                await DbHelper.instance.insertBookmarks(
                                  ...
                                  diseaseName: disease.disceaseName ?? "",
                                );
                              ...
                              bool updatedResult = await DbHelper.instance
                                  .checkBookmarksExists(disease.id);
                              setState(() {
